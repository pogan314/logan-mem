 ...
 */
#ifndef LSM_DAEMON_HOST_INTERNAL_H
#define LSM_DAEMON_HOST_INTERNAL_H
...
typedef bool (*lsm_daemon_host_cleanup_release_for_test_fn)(void *context);
...
bool lsm_daemon_host_state_prepare_for_test(const struct lsm_daemon_ipc_endpoint *endpoint);
...
} lsm_daemon_host_http_reconcile_test_result_t;
...
} lsm_daemon_host_http_free_refusal_test_result_t;
...
#endif /* LSM_DAEMON_HOST_INTERNAL_H */
