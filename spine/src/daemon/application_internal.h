 ...
 */
#ifndef LSM_DAEMON_APPLICATION_INTERNAL_H
#define LSM_DAEMON_APPLICATION_INTERNAL_H

#include "daemon/application.h"
#include "mcp/mcp.h" /* lsm_jsonrpc_request_t */
...
bool lsm_daemon_application_session_retains_store_for_test(
    const lsm_daemon_runtime_application_session_t *session);
...
#endif /* LSM_DAEMON_APPLICATION_INTERNAL_H */
