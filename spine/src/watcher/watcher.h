 ...
 */
#ifndef LSM_WATCHER_H
#define LSM_WATCHER_H
...
typedef struct lsm_watcher lsm_watcher_t;
...
typedef int (*lsm_index_fn)(const char *project_name, const char *root_path, void *user_data);
...
typedef bool (*lsm_watcher_project_mutation_begin_fn)(void *context, const char *project);
typedef void (*lsm_watcher_project_mutation_end_fn)(void *context, const char *project);
typedef void (*lsm_watcher_project_pruned_fn)(void *context, const char *project);
 ...
 * Precondition: lsm_watcher_stop() + thread join must have completed. */
 ...
 * lsm_watcher_stop() is called. Returns 0 on clean shutdown. */
