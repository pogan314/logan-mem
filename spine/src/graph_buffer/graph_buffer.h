 ...
 */
#ifndef LSM_GRAPH_BUFFER_H
#define LSM_GRAPH_BUFFER_H
 ...
 * If id_source is NULL, behaves like lsm_gbuf_new(). */
...
typedef void (*lsm_gbuf_node_visitor_fn)(const lsm_gbuf_node_t *node, void *userdata);
void lsm_gbuf_foreach_node(const lsm_gbuf_t *gb, lsm_gbuf_node_visitor_fn fn, void *userdata);

/* Iterate all edges. */
typedef void (*lsm_gbuf_edge_visitor_fn)(const lsm_gbuf_edge_t *edge, void *userdata);
 ...
 * Vectors are carried through to lsm_write_db during the dump phase. */
