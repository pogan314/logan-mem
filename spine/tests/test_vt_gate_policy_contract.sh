...
grep -Fq 'Policy identifier: `lsm-vt-candidate-selection-v1`' "$ROOT/SECURITY.md" || \
...
grep -q '^# lsm-virustotal-results-v2$' "$RESULTS" || fail "results marker missing"
