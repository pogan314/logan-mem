 ...
 * `signature` (type annotations) is suppressed in lsm_resolve_func_name so it never doubles. */
 ...
 * def-vs-call distinction happens in lsm_resolve_func_name (returns NULL for a
 ...
 * the LSM_LANG_FSHARP branch in lsm_resolve_func_name. */
...
static const LSMEmbeddedLangSpec vue_embedded_imports[] = {
    {"script_element", "raw_text", LSM_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
static const LSMEmbeddedLangSpec svelte_embedded_imports[] = {
    {"script_element", "raw_text", LSM_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
static const LSMEmbeddedLangSpec html_embedded_imports[] = {
    {"script_element", "raw_text", LSM_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
static const LSMEmbeddedLangSpec astro_embedded_imports[] = {
    ...
    {"frontmatter", "frontmatter_js_block", LSM_LANG_JAVASCRIPT},
    {"script_element", "raw_text", LSM_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
 ...
 * gate is in lsm_resolve_func_name (returns NULL for a non-def list). */
 ...
 * lsm_resolve_func_name climbs to the parent for naming. A function application
...
static const LSMLangSpec lang_specs[LSM_LANG_COUNT] = {
    // LSM_LANG_GO
    [LSM_LANG_GO] = {LSM_LANG_GO, go_func_types, go_class_types, go_field_types, go_module_types,
    ...
    // LSM_LANG_PYTHON
    [LSM_LANG_PYTHON] = {LSM_LANG_PYTHON, py_func_types, py_class_types, empty_types,
    ...
    // LSM_LANG_JAVASCRIPT
    [LSM_LANG_JAVASCRIPT] =
        {LSM_LANG_JAVASCRIPT, js_func_types, js_class_types, empty_types, js_module_types,
    ...
    // LSM_LANG_TYPESCRIPT
    [LSM_LANG_TYPESCRIPT] = {LSM_LANG_TYPESCRIPT, ts_func_types, ts_class_types, empty_types,
    ...
    // LSM_LANG_TSX
    [LSM_LANG_TSX] =
        {LSM_LANG_TSX, ts_func_types, ts_class_types, empty_types, js_module_types, js_call_types,
    ...
    // LSM_LANG_RUST
    [LSM_LANG_RUST] = {LSM_LANG_RUST, rust_func_types, rust_class_types, rust_field_types,
    ...
    // LSM_LANG_JAVA
    [LSM_LANG_JAVA] = {LSM_LANG_JAVA, java_func_types, java_class_types, java_field_types,
    ...
    // LSM_LANG_CPP
    [LSM_LANG_CPP] = {LSM_LANG_CPP, cpp_func_types, cpp_class_types, cpp_field_types,
    ...
    // LSM_LANG_CSHARP
    [LSM_LANG_CSHARP] = {LSM_LANG_CSHARP, cs_func_types, cs_class_types, cs_field_types,
    ...
    // LSM_LANG_PHP
    [LSM_LANG_PHP] = {LSM_LANG_PHP, php_func_types, php_class_types, empty_types, php_module_types,
    ...
    // LSM_LANG_LUA
    [LSM_LANG_LUA] = {LSM_LANG_LUA, lua_func_types, empty_types, empty_types, lua_module_types,
    ...
    // LSM_LANG_SCALA
    [LSM_LANG_SCALA] = {LSM_LANG_SCALA, scala_func_types, scala_class_types, empty_types,
    ...
    // LSM_LANG_KOTLIN
    [LSM_LANG_KOTLIN] = {LSM_LANG_KOTLIN, kotlin_func_types, kotlin_class_types, empty_types,
    ...
    // LSM_LANG_RUBY
    [LSM_LANG_RUBY] = {LSM_LANG_RUBY, ruby_func_types, ruby_class_types, empty_types,
    ...
    // LSM_LANG_C
    [LSM_LANG_C] = {LSM_LANG_C, c_func_types, c_class_types, c_field_types, c_module_types,
    ...
    // LSM_LANG_BASH
    [LSM_LANG_BASH] = {LSM_LANG_BASH, bash_func_types, empty_types, empty_types, bash_module_types,
    ...
    // LSM_LANG_ZIG
    [LSM_LANG_ZIG] = {LSM_LANG_ZIG, zig_func_types, zig_class_types, zig_field_types,
    ...
    // LSM_LANG_ELIXIR
    [LSM_LANG_ELIXIR] = {LSM_LANG_ELIXIR, elixir_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_HASKELL
    [LSM_LANG_HASKELL] = {LSM_LANG_HASKELL, haskell_func_types, haskell_class_types, empty_types,
    ...
    // LSM_LANG_OCAML
    [LSM_LANG_OCAML] = {LSM_LANG_OCAML, ocaml_func_types, ocaml_class_types, empty_types,
    ...
    // LSM_LANG_OBJC
    [LSM_LANG_OBJC] = {LSM_LANG_OBJC, objc_func_types, objc_class_types, objc_field_types,
    ...
    // LSM_LANG_SWIFT
    [LSM_LANG_SWIFT] = {LSM_LANG_SWIFT, swift_func_types, swift_class_types, swift_field_types,
    ...
    // LSM_LANG_DART
    [LSM_LANG_DART] = {LSM_LANG_DART, dart_func_types, dart_class_types, dart_field_types,
    ...
    // LSM_LANG_PERL
    [LSM_LANG_PERL] = {LSM_LANG_PERL, perl_func_types, empty_types, empty_types, perl_module_types,
    ...
    // LSM_LANG_GROOVY
    [LSM_LANG_GROOVY] = {LSM_LANG_GROOVY, groovy_func_types, groovy_class_types, empty_types,
    ...
    // LSM_LANG_ERLANG
    [LSM_LANG_ERLANG] = {LSM_LANG_ERLANG, erlang_func_types, erlang_class_types, empty_types,
    ...
    // LSM_LANG_R
    [LSM_LANG_R] = {LSM_LANG_R, r_func_types, empty_types, empty_types, r_module_types,
    ...
    // LSM_LANG_HTML
    [LSM_LANG_HTML] = {LSM_LANG_HTML, empty_types, empty_types, empty_types, html_module_types,
    ...
    // LSM_LANG_CSS
    [LSM_LANG_CSS] = {LSM_LANG_CSS, empty_types, empty_types, empty_types, css_module_types,
    ...
    // LSM_LANG_SCSS
    [LSM_LANG_SCSS] = {LSM_LANG_SCSS, scss_func_types, empty_types, empty_types, scss_module_types,
    ...
    // LSM_LANG_YAML
    [LSM_LANG_YAML] = {LSM_LANG_YAML, empty_types, empty_types, empty_types, yaml_module_types,
    ...
    // LSM_LANG_TOML
    [LSM_LANG_TOML] = {LSM_LANG_TOML, empty_types, toml_class_types, empty_types, toml_module_types,
    ...
    // LSM_LANG_HCL
    [LSM_LANG_HCL] = {LSM_LANG_HCL, empty_types, hcl_class_types, empty_types, hcl_module_types,
    ...
    // LSM_LANG_SQL
    [LSM_LANG_SQL] = {LSM_LANG_SQL, sql_func_types, sql_class_types, sql_field_types,
    ...
    // LSM_LANG_DOCKERFILE
    [LSM_LANG_DOCKERFILE] = {LSM_LANG_DOCKERFILE, empty_types, empty_types, empty_types,
    ...
    // LSM_LANG_CLOJURE
    [LSM_LANG_CLOJURE] = {LSM_LANG_CLOJURE, clojure_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_FSHARP
    [LSM_LANG_FSHARP] = {LSM_LANG_FSHARP, fsharp_func_types, fsharp_class_types, empty_types,
    ...
    // LSM_LANG_JULIA
    [LSM_LANG_JULIA] = {LSM_LANG_JULIA, julia_func_types, julia_class_types, empty_types,
    ...
    // LSM_LANG_VIMSCRIPT
    [LSM_LANG_VIMSCRIPT] = {LSM_LANG_VIMSCRIPT, vim_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_NIX
    [LSM_LANG_NIX] = {LSM_LANG_NIX, nix_func_types, empty_types, empty_types, nix_module_types,
    ...
    // LSM_LANG_COMMONLISP
    [LSM_LANG_COMMONLISP] = {LSM_LANG_COMMONLISP, commonlisp_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_ELM
    [LSM_LANG_ELM] = {LSM_LANG_ELM, elm_func_types, elm_class_types, empty_types, elm_module_types,
    ...
    // LSM_LANG_FORTRAN
    [LSM_LANG_FORTRAN] = {LSM_LANG_FORTRAN, fortran_func_types, fortran_class_types, empty_types,
    ...
    // LSM_LANG_CUDA (reuses C++ node types)
    [LSM_LANG_CUDA] = {LSM_LANG_CUDA, cpp_func_types, cpp_class_types, cpp_field_types,
                       cpp_module_types, cpp_call_types, cpp_import_types, cpp_import_types,
                       cpp_branch_types, cpp_var_types, cpp_assign_types, cpp_throw_types, NULL,
                       empty_types, cpp_env_funcs, NULL, tree_sitter_cuda, NULL},

    // LSM_LANG_COBOL
    [LSM_LANG_COBOL] = {LSM_LANG_COBOL, cobol_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_VERILOG
    [LSM_LANG_VERILOG] = {LSM_LANG_VERILOG, verilog_func_types, verilog_class_types, empty_types,
    ...
    // LSM_LANG_EMACSLISP
    [LSM_LANG_EMACSLISP] = {LSM_LANG_EMACSLISP, elisp_func_types, empty_types, empty_types,
                            elisp_module_types, elisp_call_types, empty_types, empty_types,
                            empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                            NULL, NULL, tree_sitter_elisp, NULL},

    // LSM_LANG_JSON
    [LSM_LANG_JSON] = {LSM_LANG_JSON, empty_types, empty_types, empty_types, json_module_types,
    ...
    // LSM_LANG_XML
    [LSM_LANG_XML] = {LSM_LANG_XML, empty_types, xml_class_types, empty_types, xml_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_xml, NULL},

    // LSM_LANG_MARKDOWN
    [LSM_LANG_MARKDOWN] = {LSM_LANG_MARKDOWN, empty_types, markdown_class_types, empty_types,
                           markdown_module_types, empty_types, empty_types, empty_types,
                           empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                           NULL, NULL, tree_sitter_markdown, NULL},

    // LSM_LANG_MAKEFILE
    [LSM_LANG_MAKEFILE] = {LSM_LANG_MAKEFILE, makefile_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_CMAKE
    [LSM_LANG_CMAKE] = {LSM_LANG_CMAKE, cmake_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_PROTOBUF
    [LSM_LANG_PROTOBUF] = {LSM_LANG_PROTOBUF, protobuf_func_types, protobuf_class_types,
    ...
    // LSM_LANG_GRAPHQL
    [LSM_LANG_GRAPHQL] = {LSM_LANG_GRAPHQL, empty_types, graphql_class_types, graphql_field_types,
    ...
    // LSM_LANG_VUE
    [LSM_LANG_VUE] = {LSM_LANG_VUE, empty_types, empty_types, empty_types, vue_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_vue,
                      vue_embedded_imports},

    // LSM_LANG_SVELTE
    [LSM_LANG_SVELTE] = {LSM_LANG_SVELTE, empty_types, empty_types, empty_types,
    ...
    // LSM_LANG_MESON
    [LSM_LANG_MESON] = {LSM_LANG_MESON, meson_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_GLSL (reuses C node types)
    [LSM_LANG_GLSL] = {LSM_LANG_GLSL, c_func_types, c_class_types, c_field_types, c_module_types,
                       c_call_types, c_import_types, empty_types, c_branch_types, c_var_types,
                       c_assign_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_glsl,
                       NULL},

    // LSM_LANG_INI
    [LSM_LANG_INI] = {LSM_LANG_INI, empty_types, ini_class_types, empty_types, ini_module_types,
    ...
    // LSM_LANG_MATLAB
    [LSM_LANG_MATLAB] = {LSM_LANG_MATLAB, matlab_func_types, matlab_class_types, empty_types,
    ...
    // LSM_LANG_LEAN
    [LSM_LANG_LEAN] = {LSM_LANG_LEAN, lean_func_types, lean_class_types, empty_types,
    ...
    // LSM_LANG_FORM
    [LSM_LANG_FORM] = {LSM_LANG_FORM, form_func_types, empty_types, empty_types, form_module_types,
    ...
    // LSM_LANG_MAGMA
    [LSM_LANG_MAGMA] = {LSM_LANG_MAGMA, magma_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_WOLFRAM
    [LSM_LANG_WOLFRAM] = {LSM_LANG_WOLFRAM, wolfram_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_SOLIDITY
    [LSM_LANG_SOLIDITY] = {LSM_LANG_SOLIDITY, solidity_func_types, solidity_class_types,
    ...
    // LSM_LANG_TYPST
    [LSM_LANG_TYPST] = {LSM_LANG_TYPST, typst_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_GDSCRIPT
    [LSM_LANG_GDSCRIPT] = {LSM_LANG_GDSCRIPT, gdscript_func_types, gdscript_class_types,
    ...
    // LSM_LANG_QML
    [LSM_LANG_QML] =
        {LSM_LANG_QML, ts_func_types, qml_class_types, qml_field_types, js_module_types,
    ...
    // LSM_LANG_CFSCRIPT
    [LSM_LANG_CFSCRIPT] =
        {LSM_LANG_CFSCRIPT, cfscript_func_types, empty_types, cfscript_field_types, js_module_types,
    ...
    // LSM_LANG_CFML
    [LSM_LANG_CFML] = {LSM_LANG_CFML, cfml_func_types, empty_types, empty_types, cfml_module_types,
    ...
    // LSM_LANG_GLEAM
    [LSM_LANG_GLEAM] = {LSM_LANG_GLEAM, gleam_func_types, gleam_class_types, gleam_field_types,
    ...
    // LSM_LANG_POWERSHELL
    [LSM_LANG_POWERSHELL] = {LSM_LANG_POWERSHELL, powershell_func_types, powershell_class_types,
    ...
    // LSM_LANG_PASCAL
    [LSM_LANG_PASCAL] = {LSM_LANG_PASCAL, pascal_func_types, pascal_class_types, pascal_field_types,
    ...
    // LSM_LANG_DLANG
    [LSM_LANG_DLANG] = {LSM_LANG_DLANG, d_func_types, d_class_types, d_field_types, d_module_types,
    ...
    // LSM_LANG_SCHEME
    [LSM_LANG_SCHEME] = {LSM_LANG_SCHEME, scheme_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_FENNEL
    [LSM_LANG_FENNEL] = {LSM_LANG_FENNEL, fennel_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_FISH
    [LSM_LANG_FISH] = {LSM_LANG_FISH, fish_func_types, empty_types, empty_types, fish_module_types,
    ...
    // LSM_LANG_AWK
    [LSM_LANG_AWK] = {LSM_LANG_AWK, awk_func_types, empty_types, empty_types, awk_module_types,
    ...
    // LSM_LANG_ZSH
    [LSM_LANG_ZSH] = {LSM_LANG_ZSH, zsh_func_types, empty_types, empty_types, zsh_module_types,
    ...
    // LSM_LANG_TCL
    [LSM_LANG_TCL] = {LSM_LANG_TCL, tcl_func_types, tcl_class_types, empty_types, tcl_module_types,
    ...
    // LSM_LANG_ADA
    [LSM_LANG_ADA] = {LSM_LANG_ADA, ada_func_types, ada_class_types, ada_field_types,
    ...
    // LSM_LANG_AGDA
    [LSM_LANG_AGDA] = {LSM_LANG_AGDA, agda_func_types, agda_class_types, empty_types,
    ...
    // LSM_LANG_RACKET
    [LSM_LANG_RACKET] = {LSM_LANG_RACKET, racket_func_types, racket_class_types, empty_types,
    ...
    // LSM_LANG_ODIN
    [LSM_LANG_ODIN] = {LSM_LANG_ODIN, odin_func_types, odin_class_types, odin_field_types,
    ...
    // LSM_LANG_RESCRIPT
    [LSM_LANG_RESCRIPT] = {LSM_LANG_RESCRIPT, rescript_func_types, rescript_class_types,
    ...
    // LSM_LANG_PURESCRIPT
    [LSM_LANG_PURESCRIPT] = {LSM_LANG_PURESCRIPT, purescript_func_types, purescript_class_types,
    ...
    // LSM_LANG_NICKEL
    [LSM_LANG_NICKEL] = {LSM_LANG_NICKEL, nickel_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_CRYSTAL
    [LSM_LANG_CRYSTAL] = {LSM_LANG_CRYSTAL, crystal_func_types, crystal_class_types,
    ...
    // LSM_LANG_TEAL
    [LSM_LANG_TEAL] = {LSM_LANG_TEAL, teal_func_types, teal_class_types, empty_types,
    ...
    // LSM_LANG_HARE
    [LSM_LANG_HARE] = {LSM_LANG_HARE, hare_func_types, hare_class_types, empty_types,
    ...
    // LSM_LANG_PONY
    [LSM_LANG_PONY] = {LSM_LANG_PONY, pony_func_types, pony_class_types, empty_types,
    ...
    // LSM_LANG_LUAU
    [LSM_LANG_LUAU] = {LSM_LANG_LUAU, luau_func_types, luau_class_types, empty_types,
    ...
    // LSM_LANG_JANET
    [LSM_LANG_JANET] = {LSM_LANG_JANET, empty_types, empty_types, empty_types, janet_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL,
                        tree_sitter_janet_simple, NULL},

    // LSM_LANG_SWAY
    [LSM_LANG_SWAY] = {LSM_LANG_SWAY, sway_func_types, sway_class_types, empty_types,
    ...
    // LSM_LANG_NASM
    [LSM_LANG_NASM] = {LSM_LANG_NASM, nasm_func_types, nasm_class_types, empty_types,
    ...
    // LSM_LANG_ASSEMBLY
    [LSM_LANG_ASSEMBLY] = {LSM_LANG_ASSEMBLY, assembly_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_ASTRO
    [LSM_LANG_ASTRO] = {LSM_LANG_ASTRO, empty_types, empty_types, empty_types, astro_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_astro,
                        astro_embedded_imports},

    // LSM_LANG_BLADE
    [LSM_LANG_BLADE] = {LSM_LANG_BLADE, empty_types, empty_types, empty_types, blade_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_blade,
                        NULL},

    // LSM_LANG_JUST
    [LSM_LANG_JUST] = {LSM_LANG_JUST, just_func_types, empty_types, empty_types, just_module_types,
    ...
    // LSM_LANG_WGSL
    [LSM_LANG_WGSL] = {LSM_LANG_WGSL, wgsl_func_types, wgsl_class_types, empty_types,
    ...
    // LSM_LANG_KDL
    [LSM_LANG_KDL] = {LSM_LANG_KDL, empty_types, empty_types, empty_types, kdl_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_kdl, NULL},

    // LSM_LANG_JSON5
    [LSM_LANG_JSON5] = {LSM_LANG_JSON5, empty_types, empty_types, empty_types, json5_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_json5,
                        NULL},

    // LSM_LANG_JSONNET
    [LSM_LANG_JSONNET] = {LSM_LANG_JSONNET, jsonnet_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_RON
    [LSM_LANG_RON] = {LSM_LANG_RON, empty_types, empty_types, empty_types, ron_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_ron, NULL},

    // LSM_LANG_THRIFT
    [LSM_LANG_THRIFT] = {LSM_LANG_THRIFT, thrift_func_types, thrift_class_types, thrift_field_types,
    ...
    // LSM_LANG_CAPNP
    [LSM_LANG_CAPNP] = {LSM_LANG_CAPNP, capnp_func_types, capnp_class_types, capnp_field_types,
    ...
    // LSM_LANG_PROPERTIES
    [LSM_LANG_PROPERTIES] = {LSM_LANG_PROPERTIES, empty_types, empty_types, empty_types,
    ...
    // LSM_LANG_SSHCONFIG
    [LSM_LANG_SSHCONFIG] = {LSM_LANG_SSHCONFIG, empty_types, empty_types, empty_types,
                            sshconfig_module_types, empty_types, empty_types, empty_types,
                            empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                            NULL, NULL, tree_sitter_ssh_config, NULL},

    // LSM_LANG_BIBTEX
    [LSM_LANG_BIBTEX] = {LSM_LANG_BIBTEX, empty_types, empty_types, empty_types,
                         bibtex_module_types, bibtex_call_types, empty_types, empty_types,
                         empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                         NULL, NULL, tree_sitter_bibtex, NULL},

    // LSM_LANG_STARLARK
    [LSM_LANG_STARLARK] = {LSM_LANG_STARLARK, starlark_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_BICEP
    [LSM_LANG_BICEP] = {LSM_LANG_BICEP, bicep_func_types, bicep_class_types, empty_types,
    ...
    // LSM_LANG_CSV
    [LSM_LANG_CSV] = {LSM_LANG_CSV, empty_types, empty_types, empty_types, csv_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_csv, NULL},

    // LSM_LANG_REQUIREMENTS
    [LSM_LANG_REQUIREMENTS] = {LSM_LANG_REQUIREMENTS, empty_types, empty_types, empty_types,
    ...
    // LSM_LANG_HLSL
    [LSM_LANG_HLSL] = {LSM_LANG_HLSL, hlsl_func_types, hlsl_class_types, empty_types,
    ...
    // LSM_LANG_VHDL
    [LSM_LANG_VHDL] = {LSM_LANG_VHDL, vhdl_func_types, vhdl_class_types, empty_types,
    ...
    [LSM_LANG_SYSTEMVERILOG] = {LSM_LANG_SYSTEMVERILOG, systemverilog_func_types,
    ...
    // LSM_LANG_DEVICETREE
    [LSM_LANG_DEVICETREE] = {LSM_LANG_DEVICETREE, empty_types, empty_types, empty_types,
    ...
    [LSM_LANG_LINKERSCRIPT] = {LSM_LANG_LINKERSCRIPT, empty_types, empty_types, empty_types,
                               linkerscript_module_types, linkerscript_call_types, empty_types,
                               empty_types, empty_types, empty_types, empty_types, empty_types,
                               NULL, empty_types, NULL, NULL, tree_sitter_linkerscript, NULL},

    // LSM_LANG_GN
    [LSM_LANG_GN] = {LSM_LANG_GN, empty_types, empty_types, empty_types, gn_module_types,
    ...
    // LSM_LANG_KCONFIG
    [LSM_LANG_KCONFIG] = {LSM_LANG_KCONFIG, empty_types, kconfig_class_types, empty_types,
    ...
    // LSM_LANG_BITBAKE
    [LSM_LANG_BITBAKE] = {LSM_LANG_BITBAKE, bitbake_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_SMALI
    [LSM_LANG_SMALI] = {LSM_LANG_SMALI, smali_func_types, smali_class_types, smali_field_types,
                        smali_module_types, empty_types, smali_import_types, empty_types,
                        empty_types, empty_types, empty_types, empty_types, NULL, empty_types, NULL,
                        NULL, tree_sitter_smali, NULL},

    // LSM_LANG_TABLEGEN
    [LSM_LANG_TABLEGEN] = {LSM_LANG_TABLEGEN, tablegen_func_types, tablegen_class_types,
                           empty_types, tablegen_module_types, empty_types, tablegen_import_types,
                           empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
                           empty_types, NULL, NULL, tree_sitter_tablegen, NULL},

    // LSM_LANG_ISPC
    [LSM_LANG_ISPC] = {LSM_LANG_ISPC, ispc_func_types, ispc_class_types, empty_types,
    ...
    // LSM_LANG_CAIRO
    [LSM_LANG_CAIRO] = {LSM_LANG_CAIRO, cairo_func_types, cairo_class_types, empty_types,
    ...
    // LSM_LANG_MOVE
    [LSM_LANG_MOVE] = {LSM_LANG_MOVE, move_func_types, empty_types, empty_types, move_module_types,
    ...
    // LSM_LANG_SQUIRREL
    [LSM_LANG_SQUIRREL] = {LSM_LANG_SQUIRREL, squirrel_func_types, squirrel_class_types,
    ...
    // LSM_LANG_FUNC
    [LSM_LANG_FUNC] = {LSM_LANG_FUNC, func_func_types, empty_types, empty_types, func_module_types,
    ...
    // LSM_LANG_REGEX
    [LSM_LANG_REGEX] = {LSM_LANG_REGEX, empty_types, empty_types, empty_types, regex_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_regex,
                        NULL},

    // LSM_LANG_JSDOC
    [LSM_LANG_JSDOC] = {LSM_LANG_JSDOC, empty_types, empty_types, empty_types, jsdoc_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_jsdoc,
                        NULL},

    // LSM_LANG_RST
    [LSM_LANG_RST] = {LSM_LANG_RST, empty_types, empty_types, empty_types, rst_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_rst, NULL},

    // LSM_LANG_BEANCOUNT
    [LSM_LANG_BEANCOUNT] = {LSM_LANG_BEANCOUNT, empty_types, empty_types, empty_types,
                            beancount_module_types, empty_types, beancount_import_types,
                            empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
                            empty_types, NULL, NULL, tree_sitter_beancount, NULL},

    // LSM_LANG_MERMAID
    [LSM_LANG_MERMAID] = {LSM_LANG_MERMAID, empty_types, empty_types, empty_types,
                          mermaid_module_types, empty_types, empty_types, empty_types, empty_types,
                          empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                          tree_sitter_mermaid, NULL},

    // LSM_LANG_PUPPET
    [LSM_LANG_PUPPET] = {LSM_LANG_PUPPET, puppet_func_types, puppet_class_types, empty_types,
    ...
    // LSM_LANG_SMITHY
    [LSM_LANG_SMITHY] = {LSM_LANG_SMITHY, smithy_func_types, smithy_class_types, smithy_field_types,
                         smithy_module_types, empty_types, smithy_import_types, empty_types,
                         empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                         NULL, NULL, tree_sitter_smithy, NULL},

    // LSM_LANG_WIT
    [LSM_LANG_WIT] = {LSM_LANG_WIT, wit_func_types, wit_class_types, wit_field_types,
                      wit_module_types, empty_types, wit_import_types, empty_types, empty_types,
                      empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                      tree_sitter_wit, NULL},

    // LSM_LANG_TLAPLUS
    [LSM_LANG_TLAPLUS] = {LSM_LANG_TLAPLUS, tlaplus_func_types, empty_types, empty_types,
    ...
    // LSM_LANG_PKL
    [LSM_LANG_PKL] = {LSM_LANG_PKL, pkl_func_types, pkl_class_types, empty_types, pkl_module_types,
    ...
    // LSM_LANG_GOMOD
    [LSM_LANG_GOMOD] = {LSM_LANG_GOMOD, empty_types, empty_types, empty_types, gomod_module_types,
    ...
    // LSM_LANG_APEX
    [LSM_LANG_APEX] = {LSM_LANG_APEX, apex_func_types, apex_class_types, apex_field_types,
    ...
    // LSM_LANG_SOQL
    [LSM_LANG_SOQL] = {LSM_LANG_SOQL, empty_types, empty_types, empty_types, soql_module_types,
    ...
    // LSM_LANG_SOSL
    [LSM_LANG_SOSL] = {LSM_LANG_SOSL, empty_types, empty_types, empty_types, sosl_module_types,
    ...
    // LSM_LANG_KUSTOMIZE — reuses YAML grammar; semantic extraction via lsm_extract_k8s()
    [LSM_LANG_KUSTOMIZE] = {LSM_LANG_KUSTOMIZE, yaml_var_types, empty_types, empty_types,
                            yaml_module_types, empty_types, empty_types, empty_types, empty_types,
                            empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                            tree_sitter_yaml, NULL},

    // LSM_LANG_K8S — reuses YAML grammar; semantic extraction via lsm_extract_k8s()
    [LSM_LANG_K8S] = {LSM_LANG_K8S, yaml_var_types, empty_types, empty_types, yaml_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_yaml, NULL},

    // LSM_LANG_PINE — Pine Script (TradingView). kvarenzn/tree-sitter-pine (ISC).
    [LSM_LANG_PINE] = {LSM_LANG_PINE, pine_func_types, pine_class_types, empty_types,
    ...
    // LSM_LANG_MOJO
    [LSM_LANG_MOJO] = {LSM_LANG_MOJO, mojo_func_types, mojo_class_types, empty_types,
    ...
    // LSM_LANG_OBJECTSCRIPT_UDL — InterSystems ObjectScript class (.cls) UDL.
    // intersystems/tree-sitter-objectscript.
    [LSM_LANG_OBJECTSCRIPT_UDL] = {LSM_LANG_OBJECTSCRIPT_UDL, objectscript_udl_func_types,
    ...
    [LSM_LANG_OBJECTSCRIPT_ROUTINE] = {LSM_LANG_OBJECTSCRIPT_ROUTINE,
    ...
    // LSM_LANG_OBJECTSCRIPT_EXPORT — Studio Export XML. No grammar row: the
    // pipeline transcodes Export XML to UDL (iris_export_xml.c) and re-extracts
    // each class as LSM_LANG_OBJECTSCRIPT_UDL, so this language never reaches
    // lsm_lang_spec()/lsm_ts_language() directly. Left as a zero spec.

};

_Static_assert(sizeof(lang_specs) / sizeof(lang_specs[0]) == LSM_LANG_COUNT,
               "lang_specs array size must match LSM_LANG_COUNT");

const LSMLangSpec *lsm_lang_spec(LSMLanguage lang) {
    if (lang < 0 || lang >= LSM_LANG_COUNT) {
        return NULL;
    }
    const LSMLangSpec *spec = &lang_specs[lang];
...
const TSLanguage *lsm_ts_language(LSMLanguage lang) {
    const LSMLangSpec *spec = lsm_lang_spec(lang);
