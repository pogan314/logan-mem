#ifndef LSM_LSP_JAVA_LSP_H
#define LSM_LSP_JAVA_LSP_H
 ...
 *   2. Build a LSMTypeRegistry from this file's LSMDefinitions + Java
 ...
 *   5. Emit LSMResolvedCall entries with confidence ≥ 0.6 (the LSP floor
...
enum {
    LSM_JAVA_IMPORT_TYPE = 0,      /* import com.foo.Bar; — type import */
    LSM_JAVA_IMPORT_STATIC = 1,    /* import static com.foo.Bar.method; */
    LSM_JAVA_IMPORT_ON_DEMAND = 2, /* import com.foo.*; — package on-demand */
    LSM_JAVA_IMPORT_STATIC_OD = 3, /* import static com.foo.Bar.*; */
};
...
typedef struct {
    ...
    /* Import map. Each entry is one of LSM_JAVA_IMPORT_*.
 ...
 * lsm_type_unknown(); never returns NULL. */
 ...
 * scoped_type_identifier, void_type, integral_type, ...) into a LSMType. */
 ...
 * type, or lsm_type_unknown() on miss. */
