...
#define REG_METHOD(class_qn_, method_name_, ret_type_) do {                        \
    ...
    rf.min_params = -1;                                                            \
    rf.qualified_name = lsm_arena_sprintf(arena, "%s.%s", (class_qn_), (method_name_)); \
    rf.short_name = (method_name_);                                                \
    rf.receiver_type = (class_qn_);                                                \
    {                                                                              \
        const LSMType **rets = (const LSMType **)lsm_arena_alloc(arena, 2 * sizeof(*rets)); \
...
void lsm_php_stdlib_register(LSMTypeRegistry *reg, LSMArena *arena) {
    ...
    REG_METHOD("Throwable", "getMessage", lsm_type_builtin(arena, "string"));
    REG_METHOD("Throwable", "getCode", lsm_type_builtin(arena, "int"));
    REG_METHOD("Throwable", "getFile", lsm_type_builtin(arena, "string"));
    REG_METHOD("Throwable", "getLine", lsm_type_builtin(arena, "int"));
    REG_METHOD("Throwable", "getTrace", lsm_type_builtin(arena, "array"));
    REG_METHOD("Throwable", "getTraceAsString", lsm_type_builtin(arena, "string"));
    REG_METHOD("Throwable", "getPrevious", lsm_type_named(arena, "Throwable"));
    ...
    REG_METHOD("DateTimeInterface", "format", lsm_type_builtin(arena, "string"));
    REG_METHOD("DateTimeInterface", "getTimestamp", lsm_type_builtin(arena, "int"));
    REG_METHOD("DateTimeInterface", "getOffset", lsm_type_builtin(arena, "int"));
    REG_METHOD("DateTime", "modify", lsm_type_named(arena, "DateTime"));
    REG_METHOD("DateTime", "add", lsm_type_named(arena, "DateTime"));
    REG_METHOD("DateTime", "sub", lsm_type_named(arena, "DateTime"));
    REG_METHOD("DateTime", "setDate", lsm_type_named(arena, "DateTime"));
    REG_METHOD("DateTime", "setTime", lsm_type_named(arena, "DateTime"));
    REG_METHOD("DateTimeImmutable", "modify", lsm_type_named(arena, "DateTimeImmutable"));
    REG_METHOD("DateTimeImmutable", "add", lsm_type_named(arena, "DateTimeImmutable"));
    REG_METHOD("DateTimeImmutable", "sub", lsm_type_named(arena, "DateTimeImmutable"));
    ...
    REG_METHOD("Iterator", "next", lsm_type_builtin(arena, "void"));
    REG_METHOD("Iterator", "rewind", lsm_type_builtin(arena, "void"));
    REG_METHOD("Iterator", "valid", lsm_type_builtin(arena, "bool"));
    REG_METHOD("Countable", "count", lsm_type_builtin(arena, "int"));
    REG_METHOD("ArrayAccess", "offsetExists", lsm_type_builtin(arena, "bool"));
    REG_METHOD("ArrayAccess", "offsetGet", MIXED);
    REG_METHOD("ArrayAccess", "offsetSet", lsm_type_builtin(arena, "void"));
    REG_METHOD("ArrayAccess", "offsetUnset", lsm_type_builtin(arena, "void"));
    REG_METHOD("Stringable", "__toString", lsm_type_builtin(arena, "string"));
    REG_METHOD("ArrayObject", "getIterator", lsm_type_named(arena, "ArrayIterator"));
    ...
    REG_METHOD("Psr.Log.LoggerInterface", "info", lsm_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "warning", lsm_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "error", lsm_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "debug", lsm_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "critical", lsm_type_builtin(arena, "void"));
    REG_METHOD("Psr.Log.LoggerInterface", "log", lsm_type_builtin(arena, "void"));
    REG_METHOD("Psr.Container.ContainerInterface", "get", MIXED);
    REG_METHOD("Psr.Container.ContainerInterface", "has", lsm_type_builtin(arena, "bool"));
    REG_METHOD("Psr.Http.Message.RequestInterface", "getMethod", lsm_type_builtin(arena, "string"));
    REG_METHOD("Psr.Http.Message.RequestInterface", "getUri",
               lsm_type_named(arena, "Psr.Http.Message.UriInterface"));
    ...
    REG_METHOD("Closure", "bindTo", lsm_type_named(arena, "Closure"));
    ...
    /* Eloquent Builder chain methods. */
    {
        ...
        const LSMType *self = lsm_type_named(arena, "Illuminate.Database.Eloquent.Builder");
        const LSMType *coll = lsm_type_named(arena, "Illuminate.Database.Eloquent.Collection");
        const LSMType *model = lsm_type_named(arena, "Illuminate.Database.Eloquent.Model");
        ...
        REG_METHOD(eb, "exists", lsm_type_builtin(arena, "bool"));
        REG_METHOD(eb, "count", lsm_type_builtin(arena, "int"));
        REG_METHOD(eb, "sum", lsm_type_builtin(arena, "int"));
        REG_METHOD(eb, "value", MIXED);
        REG_METHOD(eb, "toSql", lsm_type_builtin(arena, "string"));
    }

    /* Eloquent Model: convenience static-call entry points. */
    {
        const char *em = "Illuminate.Database.Eloquent.Model";
        const LSMType *eb = lsm_type_named(arena, "Illuminate.Database.Eloquent.Builder");
        const LSMType *self = lsm_type_named(arena, "Illuminate.Database.Eloquent.Model");
        const LSMType *coll = lsm_type_named(arena, "Illuminate.Database.Eloquent.Collection");
        ...
        REG_METHOD(em, "save", lsm_type_builtin(arena, "bool"));
        REG_METHOD(em, "update", lsm_type_builtin(arena, "bool"));
        REG_METHOD(em, "delete", lsm_type_builtin(arena, "bool"));
        REG_METHOD(em, "fresh", self);
        REG_METHOD(em, "refresh", self);
        REG_METHOD(em, "load", self);
        REG_METHOD(em, "loadMissing", self);
        REG_METHOD(em, "toArray", lsm_type_builtin(arena, "array"));
        REG_METHOD(em, "toJson", lsm_type_builtin(arena, "string"));
    ...
    /* Illuminate\Support\Collection — chain returns self. */
    {
        ...
        const LSMType *self = lsm_type_named(arena, "Illuminate.Support.Collection");
        ...
        REG_METHOD(coll_qn, "count", lsm_type_builtin(arena, "int"));
        REG_METHOD(coll_qn, "isEmpty", lsm_type_builtin(arena, "bool"));
        REG_METHOD(coll_qn, "isNotEmpty", lsm_type_builtin(arena, "bool"));
        REG_METHOD(coll_qn, "contains", lsm_type_builtin(arena, "bool"));
        REG_METHOD(coll_qn, "toArray", lsm_type_builtin(arena, "array"));
        REG_METHOD(coll_qn, "toJson", lsm_type_builtin(arena, "string"));
        REG_METHOD(coll_qn, "implode", lsm_type_builtin(arena, "string"));
        REG_METHOD(coll_qn, "sum", lsm_type_builtin(arena, "int"));
        REG_METHOD(coll_qn, "avg", lsm_type_builtin(arena, "float"));
    ...
    REG_TYPE("Carbon.CarbonImmutable", "CarbonImmutable", false, carbon_parents);
    {
        ...
        const LSMType *self = lsm_type_named(arena, "Carbon.Carbon");
        ...
        REG_METHOD(c, "format", lsm_type_builtin(arena, "string"));
        REG_METHOD(c, "toDateString", lsm_type_builtin(arena, "string"));
        REG_METHOD(c, "toDateTimeString", lsm_type_builtin(arena, "string"));
        REG_METHOD(c, "diffInDays", lsm_type_builtin(arena, "int"));
        REG_METHOD(c, "diffInHours", lsm_type_builtin(arena, "int"));
        REG_METHOD(c, "diffInMinutes", lsm_type_builtin(arena, "int"));
    ...
    REG_METHOD("Psr.Http.Message.RequestInterface", "withMethod",
               lsm_type_named(arena, "Psr.Http.Message.RequestInterface"));
    REG_METHOD("Psr.Http.Message.RequestInterface", "withUri",
               lsm_type_named(arena, "Psr.Http.Message.RequestInterface"));
    REG_METHOD("Psr.Http.Message.ResponseInterface", "withStatus",
               lsm_type_named(arena, "Psr.Http.Message.ResponseInterface"));
    ...
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "persist", lsm_type_builtin(arena, "void"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "remove", lsm_type_builtin(arena, "void"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "flush", lsm_type_builtin(arena, "void"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "createQuery",
               lsm_type_named(arena, "Doctrine.ORM.Query"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "createQueryBuilder",
               lsm_type_named(arena, "Doctrine.ORM.QueryBuilder"));
    REG_METHOD("Doctrine.ORM.EntityManagerInterface", "getRepository",
               lsm_type_named(arena, "Doctrine.ORM.EntityRepository"));
    {
        const char *qb = "Doctrine.ORM.QueryBuilder";
        const LSMType *self = lsm_type_named(arena, "Doctrine.ORM.QueryBuilder");
        ...
        REG_METHOD(qb, "getQuery", lsm_type_named(arena, "Doctrine.ORM.Query"));
    }
    REG_METHOD("Doctrine.ORM.Query", "getResult", lsm_type_builtin(arena, "array"));
    REG_METHOD("Doctrine.ORM.Query", "getOneOrNullResult", MIXED);
    REG_METHOD("Doctrine.ORM.Query", "execute", lsm_type_builtin(arena, "array"));
    REG_METHOD("Doctrine.ORM.EntityRepository", "find", MIXED);
    REG_METHOD("Doctrine.ORM.EntityRepository", "findAll", lsm_type_builtin(arena, "array"));
    REG_METHOD("Doctrine.ORM.EntityRepository", "findBy", lsm_type_builtin(arena, "array"));
    ...
    REG_METHOD("Twig.Environment", "render", lsm_type_builtin(arena, "string"));
    REG_METHOD("Twig.Environment", "load",
               lsm_type_named(arena, "Twig.TemplateWrapper"));
    REG_METHOD("Twig.Environment", "createTemplate",
               lsm_type_named(arena, "Twig.TemplateWrapper"));
    REG_METHOD("Twig.TemplateWrapper", "render", lsm_type_builtin(arena, "string"));
    REG_METHOD("Twig.TemplateWrapper", "renderBlock", lsm_type_builtin(arena, "string"));
    ...
    REG_METHOD("Symfony.Contracts.Cache.CacheInterface", "delete", lsm_type_builtin(arena, "bool"));
    REG_METHOD("Symfony.Contracts.Cache.ItemInterface", "set",
               lsm_type_named(arena, "Symfony.Contracts.Cache.ItemInterface"));
    ...
    REG_METHOD("Psr.Cache.CacheItemPoolInterface", "getItem",
               lsm_type_named(arena, "Psr.Cache.CacheItemInterface"));
               ...
               lsm_type_builtin(arena, "void"));
    {
        ...
        const LSMType *self = lsm_type_named(arena, "Symfony.Component.Mime.Email");
    ...
    REG_METHOD("Illuminate.Http.Request", "all", lsm_type_builtin(arena, "array"));
    REG_METHOD("Illuminate.Http.Request", "user", MIXED);
    REG_METHOD("Illuminate.Http.Request", "validate", lsm_type_builtin(arena, "array"));
    REG_METHOD("Illuminate.Http.Response", "header",
               lsm_type_named(arena, "Illuminate.Http.Response"));
    REG_METHOD("Illuminate.Http.Response", "withHeaders",
               lsm_type_named(arena, "Illuminate.Http.Response"));
    REG_METHOD("Illuminate.Http.JsonResponse", "header",
               lsm_type_named(arena, "Illuminate.Http.JsonResponse"));
    ...
    REG_METHOD("Illuminate.Contracts.Auth.Guard", "user",
               lsm_type_named(arena, "Illuminate.Contracts.Auth.Authenticatable"));
    REG_METHOD("Illuminate.Contracts.Auth.Guard", "check", lsm_type_builtin(arena, "bool"));
    ...
    REG_METHOD("Illuminate.Contracts.Session.Session", "put", lsm_type_builtin(arena, "void"));
    REG_METHOD("Illuminate.Contracts.Session.Session", "has", lsm_type_builtin(arena, "bool"));
    REG_METHOD("Illuminate.Contracts.Session.Session", "flash", lsm_type_builtin(arena, "void"));

    REG_TYPE("Illuminate.View.View", "View", false, session_parents);
    REG_METHOD("Illuminate.View.View", "render", lsm_type_builtin(arena, "string"));
    REG_METHOD("Illuminate.View.View", "with",
               lsm_type_named(arena, "Illuminate.View.View"));
    ...
    REG_METHOD("React.Promise.PromiseInterface", "then",
               lsm_type_named(arena, "React.Promise.PromiseInterface"));
    ...
    REG_METHOD("GuzzleHttp.Promise.PromiseInterface", "then",
               lsm_type_named(arena, "GuzzleHttp.Promise.PromiseInterface"));
    ...
    REG_METHOD("Monolog.Logger", "pushHandler",
               lsm_type_named(arena, "Monolog.Logger"));
    ...
    REG_METHOD("ReflectionClass", "getName", lsm_type_builtin(arena, "string"));
    REG_METHOD("ReflectionClass", "getMethods", lsm_type_builtin(arena, "array"));
    REG_METHOD("ReflectionClass", "getMethod",
               lsm_type_named(arena, "ReflectionMethod"));
    ...
    REG_METHOD("ReflectionMethod", "getName", lsm_type_builtin(arena, "string"));
    REG_METHOD("ReflectionProperty", "getValue", MIXED);
    REG_METHOD("ReflectionProperty", "setValue", lsm_type_builtin(arena, "void"));
}
