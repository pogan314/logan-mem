...
#define REG_EXTENSION(qn_, short_name_, recv_, ret_type_)            \
    do {                                                             \
        ...
        {                                                            \
            ...
            rets[1] = NULL;                                          \
            const char **pnames =                                    \
                (const char **)lsm_arena_alloc(arena, 2 * sizeof(*pnames)); \
            pnames[0] = "this";                                       \
            pnames[1] = NULL;                                        \
            const LSMType **ptypes =                                 \
                (const LSMType **)lsm_arena_alloc(arena, 2 * sizeof(*ptypes)); \
            ptypes[0] = (recv_);                                     \
            ptypes[1] = NULL;                                        \
            rf.signature = lsm_type_func(arena, pnames, ptypes, rets); \
        }                                                            \
        lsm_registry_add_func(reg, rf);                              \
    } while (0)

#define OBJ() lsm_type_named(arena, "System.Object")
#define STR() lsm_type_named(arena, "System.String")
#define INT() lsm_type_named(arena, "System.Int32")
#define LONG_T() lsm_type_named(arena, "System.Int64")
#define BOOL_T() lsm_type_named(arena, "System.Boolean")
#define DBL() lsm_type_named(arena, "System.Double")
#define VOID_T() lsm_type_named(arena, "System.Void")
#define UNK() lsm_type_unknown()
...
void lsm_csharp_stdlib_register(LSMTypeRegistry *reg, LSMArena *arena) {
    ...
    REG_METHOD("System.Object", "GetType", lsm_type_named(arena, "System.Type"));
    ...
    REG_METHOD("System.String", "Split",
               lsm_type_template(arena, "System.Array",
                                 (const LSMType *[]){STR(), NULL}, 1));
    ...
    REG_METHOD("System.String", "ToCharArray",
               lsm_type_template(arena, "System.Array",
                                 (const LSMType *[]){lsm_type_named(arena, "System.Char"), NULL},
                                 1));
    ...
    REG_STATIC("System.Convert", "ToSingle", lsm_type_named(arena, "System.Single"));
    REG_STATIC("System.Convert", "ChangeType", OBJ());

    /* ── System.Guid ───────────────────────────────────────────── */
    REG_TYPE("System.Guid", "Guid", false, valuetype_parent);
    REG_STATIC("System.Guid", "NewGuid", lsm_type_named(arena, "System.Guid"));
    REG_STATIC("System.Guid", "Parse", lsm_type_named(arena, "System.Guid"));
    ...
    REG_STATIC("System.DateTime", "Now", lsm_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "UtcNow", lsm_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "Today", lsm_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "Parse", lsm_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "TryParse", BOOL_T());
    REG_METHOD("System.DateTime", "AddDays", lsm_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddHours", lsm_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddMinutes", lsm_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddSeconds", lsm_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddMilliseconds", lsm_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "Subtract", lsm_type_named(arena, "System.TimeSpan"));
    REG_METHOD("System.DateTime", "ToString", STR());
    REG_METHOD("System.DateTime", "ToUniversalTime", lsm_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "ToLocalTime", lsm_type_named(arena, "System.DateTime"));
    ...
    REG_STATIC("System.DateTimeOffset", "Now", lsm_type_named(arena, "System.DateTimeOffset"));
    REG_STATIC("System.DateTimeOffset", "UtcNow", lsm_type_named(arena, "System.DateTimeOffset"));
    ...
    REG_STATIC("System.IO.File", "ReadAllBytes",
               lsm_type_template(arena, "System.Array",
                                 (const LSMType *[]){lsm_type_named(arena, "System.Byte"), NULL},
                                 1));
    ...
    REG_STATIC("System.IO.File", "Open", lsm_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "OpenRead", lsm_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "OpenWrite", lsm_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "Create", lsm_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "ReadAllTextAsync",
               lsm_type_template(arena, "System.Threading.Tasks.Task",
                                 (const LSMType *[]){STR(), NULL}, 1));
    REG_STATIC("System.IO.File", "WriteAllTextAsync",
               lsm_type_named(arena, "System.Threading.Tasks.Task"));
    ...
    REG_STATIC("System.IO.Directory", "CreateDirectory",
               lsm_type_named(arena, "System.IO.DirectoryInfo"));
    ...
    REG_STATIC("System.IO.Directory", "EnumerateFiles",
               lsm_type_template(arena, "System.Collections.Generic.IEnumerable",
                                 (const LSMType *[]){STR(), NULL}, 1));
    ...
    REG_METHOD("System.Text.StringBuilder", "Append",
               lsm_type_named(arena, "System.Text.StringBuilder"));
    ...
    REG_STATIC("System.Text.Encoding", "UTF8", lsm_type_named(arena, "System.Text.Encoding"));
    REG_STATIC("System.Text.Encoding", "ASCII", lsm_type_named(arena, "System.Text.Encoding"));
    REG_STATIC("System.Text.Encoding", "Unicode", lsm_type_named(arena, "System.Text.Encoding"));
    ...
    REG_STATIC("System.Text.RegularExpressions.Regex", "Match",
               lsm_type_named(arena, "System.Text.RegularExpressions.Match"));
    REG_STATIC("System.Text.RegularExpressions.Regex", "Matches",
               lsm_type_named(arena, "System.Text.RegularExpressions.MatchCollection"));
    ...
    REG_METHOD("System.Collections.Generic.IEnumerable", "GetEnumerator",
               lsm_type_template(arena, "System.Collections.Generic.IEnumerator",
                                 (const LSMType *[]){lsm_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Collections.Generic.List", "Find", lsm_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.List", "FindAll",
               lsm_type_template(arena, "System.Collections.Generic.List",
                                 (const LSMType *[]){lsm_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Collections.Generic.IDictionary", "Keys",
               lsm_type_template(arena, "System.Collections.Generic.ICollection",
                                 (const LSMType *[]){lsm_type_type_param(arena, "TKey"), NULL},
                                 1));
    REG_METHOD("System.Collections.Generic.IDictionary", "Values",
               lsm_type_template(arena, "System.Collections.Generic.ICollection",
                                 (const LSMType *[]){lsm_type_type_param(arena, "TValue"), NULL},
                                 1));
    ...
    REG_METHOD("System.Collections.Generic.Queue", "Dequeue", lsm_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.Queue", "Peek", lsm_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Collections.Generic.Stack", "Pop", lsm_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.Stack", "Peek", lsm_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Collections.Generic.KeyValuePair", "Key",
               lsm_type_type_param(arena, "TKey"));
    REG_METHOD("System.Collections.Generic.KeyValuePair", "Value",
               lsm_type_type_param(arena, "TValue"));
    ...
    REG_METHOD("System.Span", "Slice",
               lsm_type_template(arena, "System.Span",
                                 (const LSMType *[]){lsm_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.ReadOnlySpan", "Slice",
               lsm_type_template(arena, "System.ReadOnlySpan",
                                 (const LSMType *[]){lsm_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Nullable", "Value", lsm_type_type_param(arena, "T"));
    REG_METHOD("System.Nullable", "GetValueOrDefault", lsm_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Threading.Tasks.Task", "Exception",
               lsm_type_named(arena, "System.AggregateException"));
    ...
    REG_METHOD("System.Threading.CancellationTokenSource", "Token",
               lsm_type_named(arena, "System.Threading.CancellationToken"));
    ...
    REG_METHOD("System.Exception", "InnerException",
               lsm_type_named(arena, "System.Exception"));
    ...
    REG_EXTENSION("System.Linq.Enumerable.Where", "Where",
                   lsm_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const LSMType *[]){lsm_type_type_param(arena, "T"), NULL},
                                     1),
                   lsm_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const LSMType *[]){lsm_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_EXTENSION("System.Linq.Enumerable.OrderBy", "OrderBy",
                   lsm_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const LSMType *[]){lsm_type_type_param(arena, "T"), NULL},
                                     1),
                   lsm_type_template(arena, "System.Linq.IOrderedEnumerable",
                                     (const LSMType *[]){lsm_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_EXTENSION("System.Linq.Enumerable.ToDictionary", "ToDictionary",
                   lsm_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const LSMType *[]){lsm_type_type_param(arena, "T"), NULL},
                                     1),
                   lsm_type_template(arena, "System.Collections.Generic.Dictionary",
                                     (const LSMType *[]){UNK(), UNK(), NULL}, 2));
    REG_EXTENSION("System.Linq.Enumerable.ToHashSet", "ToHashSet",
                   lsm_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const LSMType *[]){lsm_type_type_param(arena, "T"), NULL},
                                     1),
                   lsm_type_template(arena, "System.Collections.Generic.HashSet",
                                     (const LSMType *[]){lsm_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_STATIC("System.Text.Json.JsonDocument", "Parse",
               lsm_type_named(arena, "System.Text.Json.JsonDocument"));
    ...
    REG_METHOD("System.Net.Http.HttpResponseMessage", "EnsureSuccessStatusCode",
               lsm_type_named(arena, "System.Net.Http.HttpResponseMessage"));
    ...
    REG_METHOD("System.Net.Http.HttpResponseMessage", "Content",
               lsm_type_named(arena, "System.Net.Http.HttpContent"));
    ...
    REG_METHOD("Microsoft.Extensions.Logging.ILogger", "BeginScope",
               lsm_type_named(arena, "System.IDisposable"));
    ...
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "Ok",
               lsm_type_named(arena, "Microsoft.AspNetCore.Mvc.OkObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "NotFound",
               lsm_type_named(arena, "Microsoft.AspNetCore.Mvc.NotFoundObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "BadRequest",
               lsm_type_named(arena, "Microsoft.AspNetCore.Mvc.BadRequestObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "StatusCode",
               lsm_type_named(arena, "Microsoft.AspNetCore.Mvc.IActionResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "Json",
               lsm_type_named(arena, "Microsoft.AspNetCore.Mvc.JsonResult"));
    ...
    REG_METHOD("Microsoft.EntityFrameworkCore.DbSet", "Find", lsm_type_type_param(arena, "T"));
    REG_METHOD("Microsoft.EntityFrameworkCore.DbSet", "FindAsync",
               lsm_type_template(arena, "System.Threading.Tasks.ValueTask",
                                 (const LSMType *[]){lsm_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Lazy", "Value", lsm_type_type_param(arena, "T"));
    ...
    REG_GENERIC_TYPE_P1("System.Func", "Func", false,
                         "System.Delegate", single_t_params);
    REG_METHOD("System.Func", "Invoke", lsm_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Tuple", "Item1", lsm_type_type_param(arena, "T"));
    ...
    REG_STATIC("System.Diagnostics.Stopwatch", "StartNew",
               lsm_type_named(arena, "System.Diagnostics.Stopwatch"));
    ...
    REG_METHOD("System.Diagnostics.Stopwatch", "Elapsed",
               lsm_type_named(arena, "System.TimeSpan"));
