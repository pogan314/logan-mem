#ifndef LSM_LSP_C_LSP_H
#define LSM_LSP_C_LSP_H

#include "type_rep.h"
#include "scope.h"
#include "type_registry.h"
#include "../lsm.h"
#include "go_lsp.h" // for LSMLSPDef, LSMResolvedCallArray
...
typedef struct {
    ...
    LSMSourceOrigin source_origin; // source buffer represented by emitted occurrence spans
...
void lsm_c_stdlib_register(LSMTypeRegistry *reg, LSMArena *arena);
