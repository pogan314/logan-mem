...
| Docstring coverage | What fraction of a codebase's files and symbols have a docstring. In this repo, `plugin/scripts/docstring-coverage.sh` computes it by running the spine's `docstrings` subcommand over every tracked file. |
